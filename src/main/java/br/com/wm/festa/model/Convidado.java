...
public class Convidado implements Serializable {
	...
	@GeneratedValue(generator = "increment") //livro heroku postgre
	@GenericGenerator( name = "increment", strategy = "increment") //livro heroku postgre
	private Long id;
